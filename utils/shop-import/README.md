...
| **PIKO** | Katalog-PDF → Text | `pdftotext -layout …pdf .tmp/piko_2026_h0.txt` dann `python3 utils/piko/catalog-extract/extract_piko_h0_catalog.py --articles-queue-out .tmp/piko_shop_article_numbers.txt` |
...
```bash
pdftotext -layout pfad/zu/piko_2026_h0.pdf .tmp/piko_2026_h0.txt
